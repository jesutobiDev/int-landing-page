...
const Solutions = () => {
  return (
    <div className='relative w-full bg-cover text-white p-7 lg:px-20 lg:py-20 flex flex-col lg:flex-row lg:items-center justify-start gap-20 lg:gap-[200px] lg:h-[370px] h-[260px] leading-[47px]  font-medium'>
