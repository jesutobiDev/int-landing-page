...
const Solutions = () => {
  return (
    <div className='relative w-full bg-black bg-cover text-white p-7 lg:px-20 lg:py-20 flex flex-col lg:flex-row lg:items-center justify-start gap-20 lg:gap-[200px]'>
